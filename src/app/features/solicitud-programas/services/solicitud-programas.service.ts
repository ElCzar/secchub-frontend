...
export class SolicitudProgramasService {
  ...
  getRequestsForSection(): Observable<SolicitudDto[]> {
    const mock: SolicitudDto[] = [
      { id: 1, program: 'Ingeniería de Sistemas', materia: 'Algoritmos', cupos: 30, startDate: '2025-02-01', endDate: '2025-06-30',
        schedules: [{ day: 'LUN', startTime: '08:00', endTime: '10:00', disability: false, modality: 'PRESENCIAL', roomType: 'Aulas' }]
      },
      { id: 2, program: 'Ingeniería de Sistemas', materia: 'Bases de Datos', cupos: 25, startDate: '2025-02-01', endDate: '2025-06-30',
        schedules: [{ day: 'MAR', startTime: '10:00', endTime: '12:00', disability: false, modality: 'PRESENCIAL', roomType: 'Laboratorio' }]
      },
      { id: 3, program: 'Ingeniería Electrónica', materia: 'Electrónica I', cupos: 20, startDate: '2025-02-01', endDate: '2025-06-30',
